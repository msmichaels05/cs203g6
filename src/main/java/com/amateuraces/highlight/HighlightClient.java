...
public class HighlightClient {
     ...
     * @return
     */
    public Highlight getHighlight(final String URI, final HighlightKey id) {
        final Highlight highlight = template.getForObject(URI + "/" + id.getYear() + "/" + id.getMonth(), Highlight.class);
        return highlight;
    }
