...
//     private Long lowerReservedId;

//     private Long upperReservedId;
...
//         Arrays.sort(playerArray, new EloComparator());
...
//         if (seededPlayersSize < 4 || totalPlayers <= 8) {
...
//         if (seededPlayersSize < 8 || totalPlayers <= 16) {
//             fillRemainingSlots(playerSlotAssignment, unseededPlayers, totalSlots);
//             return playerSlotAssignment;
...
//         int totalRounds = (int) Math.ceil(Math.log(playerCount) / Math.log(2)) + 1;
...
//             if (isFirstMatch) {
//                 lowerReservedId = tempMatch.getId();
//             }

//             // Update winner if there are walkovers / BYE
//             if (player1 == null && player2 == null) tempMatch.setWinner(null);

//             if (player1 == null) tempMatch.setWinner(player2);

//             if (player2 == null) tempMatch.setWinner(player1);
...
//         for (Long i = lowerReservedId+match; i<upperReservedId; i++) {
